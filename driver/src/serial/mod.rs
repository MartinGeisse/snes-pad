...
/*
Idee: Ein byte lesen (buf[1], wenn size=0 ist nichts gekommen). u8. Wenn > 128 dann aktivieren.
Shift-in. Wenn aktivierbit gesetzt dann state laden. Also von links reinschieben; Aktivierbit ist #15.
